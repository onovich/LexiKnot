...
Project: LexiKnot
Repository root: D:/LabProjects/LexiKnot
...
```
powershell
git -c safe.directory=D:/LabProjects/LexiKnot status --short --branch
```
...
```
powershell
git -c safe.directory=D:/LabProjects/LexiKnot push -u origin HEAD
```

## Docs And TODO

Keep docs/LexiKnot-project-brief.md and docs/project-knowledge.md current when roadmap or architecture changes.

## Safety And Branch Policy

Do not use reset, clean, force-push, or destructive history rewrites unless explicitly requested.
